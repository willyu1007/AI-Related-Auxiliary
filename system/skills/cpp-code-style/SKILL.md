...
运行时可使用共享 CLI：`python -B <skill>/scripts/style.py --project <项目根> status|list|get|explain|check`。命令和存储细节见 [CLI 参考](references/cli.md) 与 [数据契约](references/data-contract.md)。
