#!/usr/bin/env bash
#
# A wizard guides the user through steps the agent cannot perform.
...
banner() {
  ...
  printf '%s  This wizard covers only steps that require your access or input.\n' "$DIM"
  printf '  It captures what you provide and carries it into the workflow. Stop any\n'
  printf '  time with Ctrl-C and re-run later; saved values are reused.%s\n' "$RESET"
